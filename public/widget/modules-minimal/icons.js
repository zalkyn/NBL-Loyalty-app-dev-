...
// Every icon in the system is SVG (no emoji mode); rendered via
// <nbl-icon type="svg" name="...">, hydrated by hydrateIcons() in builder.js.
// =============================================================================
...
var ICONS = {
    ...
    'chevron-left': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',

    // ── Share platforms (referral tab) ──────────────────────────────────────
    ...
    'email': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>',
    'messenger': '<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.36 2 2 6.13 2 11.7c0 2.91 1.19 5.44 3.14 7.17.16.14.26.35.27.57l.05 1.78c.04.56.61.92 1.13.69l1.99-.88c.17-.07.36-.09.53-.04.81.23 1.68.35 2.59.35 5.64 0 10-4.13 10-9.7 0-5.57-4.36-9.7-10-9.7zM17.45 9.3l-2.91 4.6c-.46.73-1.47.92-2.17.41l-2.31-1.73a.64.64 0 00-.77 0l-3.12 2.37c-.42.32-.96-.19-.67-.64l2.91-4.6c.46-.73 1.47-.92 2.17-.41l2.31 1.73c.24.18.57.17.77 0l3.12-2.37c.42-.32.97.19.67.64z"/></svg>',
    'sms': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',
};

/** Returns the raw SVG markup string for a registered icon name. */
export function icon(name) {
    return ICONS[name] || ICONS['earn-points'];
}

/** Whether a name is a registered icon — useful for guarding bad data before rendering. */
