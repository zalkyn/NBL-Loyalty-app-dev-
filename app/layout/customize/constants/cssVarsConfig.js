...
export const PRESETS = [
    ...
    },
    {
        ...
        vars: {
            ...
            "--nbl-surface": "#0a0a0a", "--nbl-surface-2": "#171717",
            "--nbl-reward-item-bg": "#171717", "--nbl-hsc-header-bg": "#171717",
            "--nbl-nav-bg": "#0a0a0a", "--nbl-nav-item-color": "#a3a3a3",
            "--nbl-text": "#fafafa", "--nbl-text-muted": "#a3a3a3",
            "--nbl-border": "#262626", "--nbl-nav-border-color": "#262626",
            "--nbl-card-bg": "#171717", "--nbl-card-border": "#262626",
            "--nbl-home-nav-color": "#1a1208",
            "--nbl-notify-bg-from": "#c2410c", "--nbl-notify-bg-to": "#f97316",
            "--nbl-notify-color": "#ffffff",
            "--nbl-notify-reward-code-bg": "rgba(255,255,255,0.18)",
            "--nbl-notify-reward-btn-bg": "#f5a623", "--nbl-notify-reward-btn-color": "#1a1208", "--nbl-notify-reward-btn-border": "#f5a623",
            "--nbl-notify-info-btn-bg": "#f5a623", "--nbl-notify-info-btn-color": "#1a1208", "--nbl-notify-info-btn-border": "#f5a623",
            "--nbl-hsc-title-color": "#ef633b", "--nbl-home-nav-color": "#ffffff"
        },
    },
];
