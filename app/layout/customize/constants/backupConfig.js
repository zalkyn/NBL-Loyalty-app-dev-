...
export const PRESETS = [
    {
        ...
        vars: {
            ...
            "--nbl-notify-bg-to": "#EF633B",
            "--nbl-notify-color": "#ffffff",
            // FIX: was solid green (#16A34A) clashing on orange notify bg — now a dark overlay in-brand
            "--nbl-notify-reward-code-bg": "rgba(0,0,0,0.28)",
            "--nbl-notify-reward-btn-bg": "#FEC643",
            "--nbl-notify-reward-btn-color": "#1a1208",
            "--nbl-notify-reward-btn-border": "#FEC643",
            "--nbl-notify-info-btn-bg": "#FEC643",
    ...
    },
    {
        ...
        vars: {
            ...
            // NEW: activity table "points spent" — universal red, kept distinct from brand purple
            "--nbl-status-negative-bg": "#fef2f2",
            "--nbl-status-negative-border": "#fecaca",
            "--nbl-status-negative-color": "#b91c1c",
            "--nbl-status-negative-soft-bg": "#fef2f2",

            // NEW: referral modal badge + copy button + code-box hover, tied to violet brand
    ...
    },
    {
        ...
        vars: {
            ...
            // NEW: dark-surface variant of negative status (softer red, matches dark card bg)
            "--nbl-status-negative-bg": "rgba(248,113,113,0.15)",
            "--nbl-status-negative-border": "rgba(248,113,113,0.35)",
            "--nbl-status-negative-color": "#fca5a5",
            "--nbl-status-negative-soft-bg": "rgba(248,113,113,0.1)",

            // NEW: modal is white (matches NB's pattern of light modal over dark widget) — badge/copy tied to indigo brand
    ...
    },
    {
        ...
        vars: {
            ...
            // NEW: red negative status — deliberately red (not green) so "spent" reads clearly against a green theme
            "--nbl-status-negative-bg": "#fef2f2",
            "--nbl-status-negative-border": "#fecaca",
            "--nbl-status-negative-color": "#b91c1c",
            "--nbl-status-negative-soft-bg": "#fef2f2",

            // NEW: modal badge/copy tied to emerald brand
            "--nbl-modal-brand-bg": "#ecfdf5",
            "--nbl-modal-brand-color": "#059669",
    ...
    },
    {
        ...
        vars: {
            ...
            "--nbl-modal-brand-color": "#0284c7",
            "--nbl-referral-copy-btn-bg": "#38bdf8",
            "--nbl-referral-copy-btn-color": "#0c4a6e",
    ...
    },
    {
        ...
        vars: {
            ...
            // NEW: true red (not rose/pink) so "spent" doesn't blend into the pink brand color
            "--nbl-status-negative-bg": "#fef2f2",
            "--nbl-status-negative-border": "#fecaca",
            "--nbl-status-negative-color": "#b91c1c",
            "--nbl-status-negative-soft-bg": "#fef2f2",
            ...
            "--nbl-modal-brand-color": "#db2777",
            "--nbl-referral-copy-btn-bg": "#f472b6",
            "--nbl-referral-copy-btn-color": "#831843",
